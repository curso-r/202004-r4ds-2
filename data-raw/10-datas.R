...
make_date(2020, 05, 06)        # Componentes

# Outros formatos
dmy_hm("06/05/20 2:25 PM") # AM/PM
mdy_hm("05/06/20 2:25 PM") # Americano
dmy("6 de maio de 2020")   # Texto
dmy("6/mai/2020")          # Texto
...
month("2020-05-06", label = TRUE, abbr = FALSE) # Mês (sem abrev.)
