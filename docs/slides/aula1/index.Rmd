...
4. Rode `devtools::load_all()`
5. Rode `?colar`
6. Rode com seu nome: `colar("Paulo", "Seldon")`
...
# Passo 2½: Configure seu nome de usuário
...
- O gabaritos serão adicionados (provavelmente) na pasta `R/`
